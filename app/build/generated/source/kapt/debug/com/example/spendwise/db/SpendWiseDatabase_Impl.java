...
public final class SpendWiseDatabase_Impl extends SpendWiseDatabase {
  ...
  protected RoomOpenDelegate createOpenDelegate() {
    final RoomOpenDelegate _openDelegate = new RoomOpenDelegate(3, "fa580257d21b58490811502c535abca0", "0f99b3279ed2e8fa6db7f6b117ff6b2d") {
      @Override
      public void createAllTables(@NonNull final SQLiteConnection connection) {
        ...
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS `custom_categories` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userId` INTEGER NOT NULL, `name` TEXT NOT NULL, `icon` TEXT NOT NULL, `color` TEXT NOT NULL, `budgetLimit` REAL NOT NULL)");
        SQLite.execSQL(connection, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        SQLite.execSQL(connection, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'fa580257d21b58490811502c535abca0')");
      }
      ...
      public RoomOpenDelegate.ValidationResult onValidateSchema(
        ...
        final Map<String, TableInfo.Column> _columnsCustomCategories = new HashMap<String, TableInfo.Column>(6);
        _columnsCustomCategories.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCustomCategories.put("userId", new TableInfo.Column("userId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCustomCategories.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCustomCategories.put("icon", new TableInfo.Column("icon", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCustomCategories.put("color", new TableInfo.Column("color", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCustomCategories.put("budgetLimit", new TableInfo.Column("budgetLimit", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final Set<TableInfo.ForeignKey> _foreignKeysCustomCategories = new HashSet<TableInfo.ForeignKey>(0);
        final Set<TableInfo.Index> _indicesCustomCategories = new HashSet<TableInfo.Index>(0);
        ...
        final TableInfo _existingCustomCategories = TableInfo.read(connection, "custom_categories");
        if (!_infoCustomCategories.equals(_existingCustomCategories)) {
          return new RoomOpenDelegate.ValidationResult(false, "custom_categories(com.example.spendwise.db.CustomCategoryEntity).\n"
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "users", "expenses", "incomes", "custom_categories");
  }

  @Override
  public void clearAllTables() {
    super.performClear(false, "users", "expenses", "incomes", "custom_categories");
  }
